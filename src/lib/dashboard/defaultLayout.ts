...
export const WIDGET_META: { id: string; label: string }[] = [
  // 4 einzelne KPI-Widgets (ersetzt altes 'stats'-Widget)
  { id: "kpiAnfragen",      label: "KPI: Aktive Anfragen"    },
  { id: "kpiBedarf",        label: "KPI: Offene BEDARF"      },
...
export const DEFAULT_LAYOUT: LayoutsMap = {
  ...
  // y=20: Footer (h=2/3)
  lg: [
    { i: "kpiAnfragen",      x: 0,  y: 0,  w: 3,  h: 2,  minW: 2,  minH: 2  },
    { i: "kpiBedarf",        x: 3,  y: 0,  w: 3,  h: 2,  minW: 2,  minH: 2  },
    { i: "kpiBestand",       x: 6,  y: 0,  w: 3,  h: 2,  minW: 2,  minH: 2  },
    { i: "kpiAuslagerungen", x: 9,  y: 0,  w: 3,  h: 2,  minW: 2,  minH: 2  },
    { i: "status",           x: 0,  y: 2,  w: 6,  h: 4,  minW: 3,  minH: 3  },
    { i: "trend",            x: 6,  y: 2,  w: 6,  h: 4,  minW: 3,  minH: 3  },
    { i: "topTeile",         x: 0,  y: 6,  w: 6,  h: 4,  minW: 3,  minH: 3  },
    { i: "techniker",        x: 6,  y: 6,  w: 6,  h: 4,  minW: 3,  minH: 3  },
    { i: "letzteAnfragen",   x: 0,  y: 10, w: 4,  h: 5,  minW: 3,  minH: 3  },
    { i: "letzteBuchungen",  x: 4,  y: 10, w: 4,  h: 5,  minW: 3,  minH: 3  },
    { i: "aktivitaet",       x: 8,  y: 10, w: 4,  h: 5,  minW: 3,  minH: 3  },
    { i: "heatmap",          x: 0,  y: 15, w: 8,  h: 5,  minW: 4,  minH: 3  },
    { i: "mindestbestand",   x: 8,  y: 15, w: 4,  h: 5,  minW: 3,  minH: 3  },
    { i: "quickActions",     x: 0,  y: 20, w: 8,  h: 2,  minW: 4,  minH: 2  },
    { i: "systemStatus",     x: 8,  y: 20, w: 4,  h: 3,  minW: 3,  minH: 2  },
  ],
  // ── Tablet (996–1279px) — 12 cols ────────────────────────────────────────
  // KPIs 2×2 Raster
  md: [
    { i: "kpiAnfragen",      x: 0,  y: 0,  w: 6,  h: 2,  minW: 3,  minH: 2  },
    { i: "kpiBedarf",        x: 6,  y: 0,  w: 6,  h: 2,  minW: 3,  minH: 2  },
    { i: "kpiBestand",       x: 0,  y: 2,  w: 6,  h: 2,  minW: 3,  minH: 2  },
    { i: "kpiAuslagerungen", x: 6,  y: 2,  w: 6,  h: 2,  minW: 3,  minH: 2  },
    { i: "status",           x: 0,  y: 4,  w: 6,  h: 4,  minW: 3,  minH: 3  },
    { i: "trend",            x: 6,  y: 4,  w: 6,  h: 4,  minW: 3,  minH: 3  },
    { i: "topTeile",         x: 0,  y: 8,  w: 6,  h: 4,  minW: 3,  minH: 3  },
    { i: "techniker",        x: 6,  y: 8,  w: 6,  h: 4,  minW: 3,  minH: 3  },
    { i: "letzteAnfragen",   x: 0,  y: 12, w: 6,  h: 5,  minW: 3,  minH: 3  },
    { i: "letzteBuchungen",  x: 6,  y: 12, w: 6,  h: 5,  minW: 3,  minH: 3  },
    { i: "aktivitaet",       x: 0,  y: 17, w: 12, h: 5,  minW: 4,  minH: 3  },
    { i: "heatmap",          x: 0,  y: 22, w: 12, h: 5,  minW: 4,  minH: 3  },
    { i: "mindestbestand",   x: 0,  y: 27, w: 6,  h: 5,  minW: 3,  minH: 3  },
    { i: "quickActions",     x: 0,  y: 32, w: 8,  h: 2,  minW: 4,  minH: 2  },
    { i: "systemStatus",     x: 8,  y: 32, w: 4,  h: 3,  minW: 3,  minH: 2  },
  ],
  // ── Mobile (≤768px) — 6 cols, stacked ────────────────────────────────────
  sm: [
    { i: "kpiAnfragen",      x: 0, y: 0,  w: 3,  h: 2,  minW: 2,  minH: 2  },
    { i: "kpiBedarf",        x: 3, y: 0,  w: 3,  h: 2,  minW: 2,  minH: 2  },
    { i: "kpiBestand",       x: 0, y: 2,  w: 3,  h: 2,  minW: 2,  minH: 2  },
    { i: "kpiAuslagerungen", x: 3, y: 2,  w: 3,  h: 2,  minW: 2,  minH: 2  },
